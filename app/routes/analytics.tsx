      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 mb-6 border border-white/20">
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            <h3 className="font-semibold text-gray-800 mb-3 text-sm">AI Analysis Summary</h3>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <h4 className="font-medium text-gray-700 mb-2 text-sm">Strengths</h4>
              ...
              <div>
                <h4 className="font-medium text-gray-700 mb-2 text-sm">Areas for Improvement</h4>
                <ul className="text-xs text-gray-600 space-y-1">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 mb-6 border border-white/20">
          ...
          {/* Areas to Improve */}
          <div className="mb-6">
            <h3 className="font-semibold text-gray-800 mb-4 text-sm">Fitness Areas Analysis</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-gray-700 text-sm">Upper Body Strength</span>
                <div className="flex items-center space-x-3">
                  <div className="w-32 bg-gray-200 rounded-full h-3">
                    <div className="bg-blue-500 h-3 rounded-full transition-all duration-1000" style={{ width: '75%' }}></div>
                  </div>
                  <span className="text-gray-600 text-sm font-medium">75%</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-700 text-sm">Core Stability</span>
                <div className="flex items-center space-x-3">
                  <div className="w-32 bg-gray-200 rounded-full h-3">
                    <div className="bg-green-500 h-3 rounded-full transition-all duration-1000" style={{ width: '60%' }}></div>
                  </div>
                  <span className="text-gray-600 text-sm font-medium">60%</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-700 text-sm">Flexibility</span>
                <div className="flex items-center space-x-3">
                  <div className="w-32 bg-gray-200 rounded-full h-3">
                    <div className="bg-yellow-500 h-3 rounded-full transition-all duration-1000" style={{ width: '45%' }}></div>
                  </div>
                  <span className="text-gray-600 text-sm font-medium">45%</span>
                </div>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-700 text-sm">Cardiovascular Endurance</span>
                <div className="flex items-center space-x-3">
                  <div className="w-32 bg-gray-200 rounded-full h-3">
                    <div className="bg-red-500 h-3 rounded-full transition-all duration-1000" style={{ width: '35%' }}></div>
                  </div>
                  <span className="text-gray-600 text-sm font-medium">35%</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-xl p-4 border border-blue-200">
            <h3 className="font-semibold text-gray-800 mb-3 text-sm">AI Recommendations</h3>
            <div className="space-y-2">
              <div className="flex items-start space-x-2">
                <div className="text-blue-500 mt-0.5">💡</div>
                <p className="text-sm text-gray-600">Focus on core strengthening exercises to improve stability</p>
              </div>
              <div className="flex items-start space-x-2">
                <div className="text-green-500 mt-0.5">💡</div>
                <p className="text-sm text-gray-600">Incorporate daily stretching routines for better flexibility</p>
              </div>
              <div className="flex items-start space-x-2">
                <div className="text-orange-500 mt-0.5">💡</div>
                <p className="text-sm text-gray-600">Add 2-3 cardio sessions per week to boost endurance</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg font-medium text-lg hover:bg-gray-300 transition-colors"
                style={{ fontFamily: 'Playfair Display, serif' }}
              >
                Back to Camera
              </button>
